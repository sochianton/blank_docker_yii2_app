...
class PushRepository implements PushRepoInterface
{
     ...
     * @return bool
     */
    public function removeTokensByUserId(int $userId): bool
    {
     ...
     * @return bool
     */
    public function add(int $userId, int $userType, string $token): bool
    {
        $model = new Push();
