...
use api\modules\employee\v1\request\LoginRequest;
use api\modules\employee\v1\response\LoginResponse;
use api\modules\employee\v1\service\AuthService;
...
class AuthController extends RestController
{
     ...
     * @OA\Post(
     *     tags={"auth employee"},
     *     path="/employee/v1/login",
     *     summary="login to server by code and token",
     *     description="login to server by code and token",
     *     @OA\RequestBody(@OA\JsonContent(ref="#/components/schemas/EmployeeLoginRequest")),
     *     @OA\Response(
     *          response="200",
     *          description="ok",
     *          @OA\JsonContent(ref="#/components/schemas/EmployeeLoginResponse"),
     *     ),
